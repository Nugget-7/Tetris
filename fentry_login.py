...
class Fentry:
    def __init__(self, x, y, lx, ly, place_holder="",
        ...
        self.font = font
        self.bg_color = bg_color if bg_color else (255, 255, 255)
        self.bg_color_active = bg_color_active if bg_color_active else (255, 255, 255)
        self.border_color = border_color if border_color else (160, 160, 160)
        self.border_color_active = border_color_active if border_color_active else (70, 130, 230)
        self.txt_color = txt_color if txt_color else (20, 20, 20)
        self.place_holder_color = place_holder_color if place_holder_color else (160, 160, 160)
        self.cursor_color = cursor_color if cursor_color else (20, 20, 20)
